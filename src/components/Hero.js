...
const Hero = ({projects}) => {
  const images = projects.map((item) => {
    //const {data: {cover_photo:{localFiles}}} = item;
    const {data: {hero_photo:{localFiles}}} = item;
    ...
    <h2>
      <Wrapper>
        <Background image={images[index]}>
          <article>
            <h3>If you can see it, I can shoot it</h3>
            <h1>Photographs are just light and time.</h1>
